...
namespace Approximation.Regression
{
    public class Graph
    {
        ...
        //    model.Series.Add(new FunctionSeries(linear.function, x.Min(), x.Max(), 0.0001));
       //     model.Series.Add(new FunctionSeries(power.function, x.Min(), x.Max(), 0.0001));
            model.Series.Add(new FunctionSeries(quadratic.function, x.Min(), x.Max(), 0.0001));
